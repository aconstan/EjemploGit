...
import dataAccess.StudentDAO;import java.io.IOException;
...
public class StudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(opcion==1){
            ...
            Student newStudent= new Student(id, name, scholarship, type);
            dao.addStudent(newStudent);
            request.setAttribute("student", newStudent);
            if (scholarship=="yes"){
                address="scholarshipStudents.jsp";
            }
            else {
                address="noScholarshipStudents.jsp";
            }
        } else if(opcion==2){
